        ...
        try {
            ...
            if (rs.next()) {
                ...
                try {
                    ...
                    stmt2.executeUpdate("UPDATE trainer SET logged_in = 1 WHERE id = '" + id + "'");
                } catch (Exception e) {
                    e.printStackTrace();
                }
                return true;
                ...
                if (rs.next()) {
                    ...
                    try {
                        Statement stmt2 = con.createStatement();
                        stmt2.executeUpdate("UPDATE nutritionist SET logged_in = 1 WHERE id = '" + id + "'");
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    return true;
                    ...
                    if (rs.next()) {
                        ...
                        try {
                            Statement stmt2 = con.createStatement();
                            stmt2.executeUpdate("UPDATE receptionist SET logged_in = 1 WHERE id = '" + id + "'");
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        return true;
                        ...
                        if (rs.next()) {
                            ...
                            try {
                                Statement stmt2 = con.createStatement();
                                stmt2.executeUpdate("UPDATE admin SET logged_in = 1 WHERE id = '" + id + "'");
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                            return true;
